    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top" id="myNav">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item">
            <Scrollchor class="nav-link" to="#about">About Us <span class="sr-only">(current)</span></Scrollchor>
          </li>
          ...
          <li class="nav-item">
            <Scrollchor class="nav-link" to="#projects">Projects<span class="sr-only">(current)</span></Scrollchor>
          </li>
          <li class="nav-item">
            <Scrollchor class="nav-link" to="#programs">Programs<span class="sr-only">(current)</span></Scrollchor>
          </li>
          <li class="nav-item">
